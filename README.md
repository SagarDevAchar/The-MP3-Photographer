...
Place the Custom PNG files generated by [**The MP3 Photographer**](https://github.com/SagarDevAchar/TheMP3Photographer) in the `SRC\` of [**The PNG Musician**](https://github.com/SagarDevAchar/ThePNGMusician) folder to play them
...
I use [Audacity](https://www.audacityteam.org/) to bring the MP3 file into the restriction limits with the following settings
